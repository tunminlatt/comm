...
@section('breadcrumbs')
    {{ Breadcrumbs::render('audio_detail', $audio->id) }}
@endsection
        ...
        <form>
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                    @php
                    $uploaded_by = \App\Models\Volunteer::find($audio->uploaded_by);
                    @endphp
                        ...
                        <div class="row push-top">
                            @foreach ($banners as $banner)
                                ...
                                @if(isset($banner['data']))
                                    @if($banner['data'] !== " ")
                                    <div class="col-md-3" style="margin-top:30px;">
                                    <a href="#" onclick="downloadFile('{{$banner['data']}}', '{{$audio->title}}.jpeg')"><button type="button" class="btn btn-default"><i class="fa fa-download"></i> Download Image</button></a>
                                    </div>
                                    @endif
                                @endif
                            @endforeach
                        ...
                        <div class="row push-top">
                            @foreach ($recordings as $recording)
                                ...
                                @if(isset($recording['data']))
                                    @if($recording['data'] !== " ")
                                    <div class="col-md-3" style="margin-top:30px;">
                                        <a href="#" onclick="downloadFile('{{$recording['data']}}', '{{$audio->title}}.mp3')"><button type="button" class="btn btn-default"><i class="fa fa-download"></i> Download Audio</button></a>
                                    </div>
                                    @endif
                                @endif
                            @endforeach
