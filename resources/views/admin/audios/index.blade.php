...
@section('js')
    ...
    <script>
        $(function () {
            ...
            let url = "{{ route('admin.audios.index', ':trash') }}"
            ...
            let buttons = [
                {
                    ...
                    action: function ( e, dt, node, config ) {
                        window.location.href = "{{ route('admin.audios.create') }}"
                    }
                },
                {
                    text: showFilterText,
                ...
                },
                {
                    ...
                    action: function ( e, dt, node, config ) {
                        ...
                        if(sData.length > 0){
                            ...
                            bootbox.confirm({
                                message: 'This selected audio(s) will be '+ deleteLabel +'! Are you sure?',
                                size: 'small',
                                backdrop: true,
                                closeButton: false,
                                callback: function (result) {
                                    if (result) {
                                        ...
                                        let delete_selected_url = "{{ route('admin.audios.deleteSelected', ':trash') }}"
            ...
            if(trash == 'trash=all'){
                ...
                buttons.push({
                    ...
                    className: 'btn btn-primary btn-sm',
                    action: function ( e, dt, node, config ) {
                        window.location.href = '/audios?trash=all';
                    }
                })
            }
            ...
            let table = $('#datatable').DataTable({
                ...
                columnDefs: [
                    ...
                    {  className: "ellipsis", targets: [4,5] }
                ],
            })
        })
