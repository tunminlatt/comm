...
@section('title', 'Volunteer Add New')
...
@section('breadcrumbs')
    {{ Breadcrumbs::render('volunteer_add_new') }}
@endsection

@section('content')
    <div class="card">
        <form method="POST" action="{{ route('admin.volunteers.store') }}" enctype="multipart/form-data" class="ajax">
            @csrf
            ...
            <div class="card-body">
                ...
                <div class="form-group row required">
                    ...
                    <div class="col-sm-10">
                        <input type="email" class="form-control" id="inputEmail" name="email" value="{{ old('email') }}" placeholder="example@gmail.com" autofocus>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <textarea maxlength="1000" rows="5" class="form-control" id="inputAddress" name="address" placeholder="Address">{{ old('address') }}</textarea>
